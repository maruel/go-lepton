// Code generated by "stringer -output=strings_gen.go -type=CameraStatus,Command,FFCShutterMode,FFCState,Flag,RegisterAddress,ShutterPosition,ShutterTempLockoutState,TelemetryLocation"; DO NOT EDIT
...
const (
	_ShutterPosition_name_0 = "ShutterPositionIdleShutterPositionOpenShutterPositionClosedShutterPositionBrakeOn"
	_ShutterPosition_name_1 = "ShutterPositionUnknown"
)

var (
	_ShutterPosition_index_0 = [...]uint8{0, 19, 38, 59, 81}
	_ShutterPosition_index_1 = [...]uint8{0, 22}
)

func (i ShutterPosition) String() string {
	switch {
	case 0 <= i && i <= 3:
		return _ShutterPosition_name_0[_ShutterPosition_index_0[i]:_ShutterPosition_index_0[i+1]]
	case i == 4294967295:
		return _ShutterPosition_name_1
	default:
		return fmt.Sprintf("ShutterPosition(%d)", i)
	}
}
...
func (i TelemetryLocation) String() string {
	if i >= TelemetryLocation(len(_TelemetryLocation_index)-1) {
